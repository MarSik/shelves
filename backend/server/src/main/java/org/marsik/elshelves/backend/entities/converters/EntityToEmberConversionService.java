...
public class EntityToEmberConversionService extends AbstractConversionService<IdentifiedEntity, AbstractEntityApiModel, UUID> implements CachingConverter<IdentifiedEntity, AbstractEntityApiModel, UUID> {
    @Override
